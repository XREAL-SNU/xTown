...
public class MinimapScreenScript : MonoBehaviour
{
    ...
    public GameObject Player;       //플레이어 오브젝트(multi로 간다면 여러개를 추가해야할 듯)
    ...
    void Update()
    {
        ...
        if(gameObject.name == "WorldMinimapScreen")
        {
            ...
            PlayerDot.GetComponent<RectTransform>().anchoredPosition = new Vector3(420/_worldWidth*_playerPos.x,420/_worldHeight*_playerPos.z,0);
