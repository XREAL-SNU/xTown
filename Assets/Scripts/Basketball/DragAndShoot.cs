...
namespace XReal.XTown.Basketball
{
    ...
    public class DragAndShoot : MonoBehaviour
    {
        ...
        private void OnMouseDrag()
        {
            ...
            Vector3 forceV = _mainCameraTransform.right * forceInit.x + _mainCameraTransform.up * forceInit.y + _mainCameraTransform.forward * forceInit.y;
            forceV *= _forceMultiplier;
        ...
        private void Shoot(Vector3 force)
        {
            ...
            Vector3 forceV = _mainCameraTransform.right * force.x + _mainCameraTransform.up * force.y + _mainCameraTransform.forward * force.y;
            forceV *= _forceMultiplier;
